...
2. Previously high-priority parity deltas XR-01, XR-02, XR-04, XR-05, and XR-08 are closed in P11; post-P15 protocol/API/runtime parity deltas are closed in P16, test-behavior parity closure is delivered in P17, and workspace-resolution/operator-clarity deltas are closed in P18.
