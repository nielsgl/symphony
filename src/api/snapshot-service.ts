...
function projectPhaseTiming(entry: { current_phase_at_ms?: number | null }, nowMs: number) {
...
function projectCodexThreadActivity(
  entry: {
...
function projectToolCallLedger(entry: { tool_call_ledger?: RunningEntry['tool_call_ledger'] }) {
...
interface RuntimeDiagnosticPageOptions {
  limit?: number;
  offset?: number;
}

function normalizeDiagnosticPageOptions(options: RuntimeDiagnosticPageOptions = {}): Required<RuntimeDiagnosticPageOptions> {
