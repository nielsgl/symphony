...
|---|---|---|---|---|
| Workflow path selection precedence | PRD-002 | orchestration planning | 17.1 | startup validation log |
| WORKFLOW loader and prompt split | PRD-002 | orchestration planning | 17.1 | workflow load/reload events |
| Typed config + defaults + `$` resolution | PRD-002 | orchestration planning | 17.1 | config validation diagnostics |
| Dynamic workflow watch/reload/re-apply | PRD-002 | orchestration planning | 17.1 | reload success/failure counters |
...
| Codex launch command config | PRD-004 + PRD-002 | orchestration planning | 17.1 + 17.5 | startup config diagnostics |
| Strict prompt rendering (`issue`, `attempt`) | PRD-002 | orchestration planning | 17.1 | template render error logs |
